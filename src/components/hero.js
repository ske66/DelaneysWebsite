...
//import leavesLeft from "../images/leavesLeft.png";

const Hero = () => {
  return (
    <section className="mt-24">
      <div class="relative container mx-auto text-center h-96 w-full flex items-center justify-center">
        ...
        <div class="relative text-center space-y-6 flex flex-col items-center">
          <h1 class="z-50">Costume Designer &amp; Maker</h1>
